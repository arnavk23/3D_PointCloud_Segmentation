...
class Config(G):
    ...
    def __call__(self, *args, **kwargs):
        ...
        while queue:
            ...
            if isinstance(
                x, (collections.abc.Sequence, collections.UserList)
